...
<body>
    <div id="page" class="page">
        ...
        <div class="title">
            ...
            -------oOo-------
            <br>
            Đơn Hàng : #<b>MHD_SETBILL_{{$setbill->id}}_{{$dt}}</b>
        </div>
        <br />
        <br />
        <p>Khách hàng: {{optional($setbill->set)->name}}</p>
        <p>
            Bàn số:
            <ul>
        ...
        <table class="TableData">
            ...
            <tr>
                ...
                <td><img src="{{asset(optional($setdetail->dish)->image)}}" class="dish_img"></td>
            ...
            <tr>
                ...
                <td class="cotSo">{{number_format($setbill->total_money, 0, ',', '.')}} đ</td>
            </tr>
        </table>
