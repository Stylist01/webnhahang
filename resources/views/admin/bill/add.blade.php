...
@section('title')
<title>Thêm mới hóa đơn tại quán</title>
@endsection
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Thêm mới hóa đơn tại quán</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form class="form-horizontal" action="{{route('bills.store')}}" method="GET" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label class="col-sm-2 control-lable">Mã hóa đơn: {{$bill_id}}</label>
                            <div class="col-sm-8">
                                <input type="hidden" name="bill_id" class="form-control" placeholder="Mã hóa đơn" value="{{$bill_id}}">
                            </div>
                        </div>
                        ...
                        <div class="from-group">
                            <div class="col-sm-set-2 col-sm-10">
                ...
                <div class="col-sm-6">
                    <div class="col-sm-set-2 col-sm-10">
                        <a href="{{route('bills.index')}}" class="btn btn-dark">Kết thúc</a>
                    </div>
                </div>
