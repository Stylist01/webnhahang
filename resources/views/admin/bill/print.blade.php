...
<body>
    <div id="page" class="page">
        ...
        <div class="title">
            ...
            -------oOo-------
            <br>
            Đơn Hàng : #<b>MHD_BILL_{{$bill->id}}_{{$dt}}</b>
        </div>
        <br />
        <br />
        <p>Bàn số : {{optional($bill->table)->name}}</p>
        <table class="TableData">
            ...
            <tr>
                ...
                <td><img src="{{asset(optional($detail->dish)->image)}}" class="dish_img"></td>
            ...
            <tr>
                ...
                <td class="cotSo">{{number_format($bill->total_money, 0, ',', '.')}} đ</td>
            </tr>
        </table>
