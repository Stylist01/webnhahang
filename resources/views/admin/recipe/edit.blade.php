...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form class="form-horizontal" action="{{route('recipes.update',['id'=>$recipe->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="dish_id" class="form-control select2 select2-danger mb-3" data-dropdown-css-class="select2-danger" style="width: 100%;">
                                    ...
                                    <option <?php if ($recipe['dish_id'] == $dish['id']) echo 'selected' ?> value="{{$dish->id}}">{{$dish->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="ingredient_id" class="form-control select2 select2-danger mb-3" data-dropdown-css-class="select2-danger" style="width: 100%;">
                                    ...
                                    <option <?php if ($recipe['ingredient_id'] == $ingredient['id']) echo 'selected' ?> value="{{$ingredient->id}}">{{$ingredient->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number" name="quantity" class="form-control" placeholder="Số lượng" value="{{$recipe->quantity}}" min=0.1>
                                @error('quantity')
