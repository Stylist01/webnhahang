...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form class="form-horizontal" action="{{route('personnels.update',['id'=>$personnel->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label class="col-sm-2 control-lable">Tên nhân viên</label>
                            <div class="col-sm-8">
                                <input type="text" name="name" class="form-control" placeholder="Tên nhân viên" value="{{$personnel->name}}">
                                @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number" name="age" class="form-control" placeholder="Tuổi" value="{{$personnel->age}}">
                                @error('age')
                                <p class="text-danger">{{$message}}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="sex" class="form-control" placeholder="Giới tính" value="{{$personnel->sex}}">
                                @error('sex')
                                <p class="text-danger">{{$message}}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select id="province_id" name="province_id" class="form-control select2 select2-danger mb-3" data-dropdown-css-class="select2-danger" style="width: 100%;">
                                    ...
                                    <option <?php if ($personnel->province_id == $province->id) echo 'selected' ?> value="{{$province->id}}">{{$province->name}}</option>
                                    @endforeach
                                </select>
                                @error('province_id')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select id="district_id" name="district_id" class="form-control select2 select2-danger mb-3" data-dropdown-css-class="select2-danger" style="width: 100%;">
                                    <option value="{{$personnel->district_id}}">{{optional($personnel->district)->name}}</option>
                                </select>
                                @error('district_id')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select id="commune_id" name="commune_id" class="form-control select2 select2-danger mb-3" data-dropdown-css-class="select2-danger" style="width: 100%;">
                                    <option value="{{$personnel->commune_id}}">{{optional($personnel->commune)->name}}</option>
                                </select>
                                @error('commune_id')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="phone" class="form-control" placeholder="Số điện thoại" value="{{$personnel->phone}}">
                                @error('phone')
                                <p class="text-danger">{{$message}}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="email" name="email" class="form-control" placeholder="Email" value="{{$personnel->email}}">
                                @error('email')
                                <p class="text-danger">{{$message}}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="position_id" class="form-control select2 select2-danger mb-3" data-dropdown-css-class="select2-danger" style="width: 100%;">
                                    ...
                                    <option <?php if ($personnel['position_id'] == $position['id']) echo 'selected' ?> value="{{$position->id}}">{{$position->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="bank" class="form-control" placeholder="Ngân hàng" value="{{$personnel->bank}}">
                                @error('bank')
                                <p class="text-danger">{{$message}}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="account_number" class="form-control" placeholder="Số tài khoản" value="{{$personnel->account_number}}">
                            ...
                            <div class="col-sm-8">
                                <label className='cursor-pointer select-wrapper'>
                                    <div className='logo-wrapper'>
                                        <img width="100px" id="img" src="{{$personnel->image}}" alt="hình ảnh">
                                    </div>
